...
class Document extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('document_src', 'file',
			'types' => 'jpg, ppt ,png, pdf, docx, txt, csv, zip, rar, tar.gz, xls, c, h, ccp,',
			'allowEmpty' => true, 'maxSize' => 50000000, 
	...
	public function relations()
	{
		...
		return array(
			...
			'kinddocument' => array(self::BELONGS_TO, 'subject','id_subject'),
		);
	}
